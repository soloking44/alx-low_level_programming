...
/**
 * allDigits - it checks if all the characters are digits.
 * @arg: the arguments of a program.
...
/**
 * _calloc- it initializes memory spaces with zero.
 * @nmemb: the string 1.
 * @size: the string 2, concatenated to 1
 *
...
/**
 * main- it multiplies 2 positive numbers.
 * @argc: a counter of arguments.
 * @argv: a vector of arguments
 * Return: the ans or Error.
 */
