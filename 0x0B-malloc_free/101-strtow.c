...
/**
 * countWords - it counts the numbers o words in the string
 *
 * @str: source string
 *
...
/**
 * countChars - it counts the numbers o characters in a string
 *
 * @str: source string
 *
 * Return: the number of words.
...
/**
 * strtow - it separates the character to an string of words
 *
 * @str: source string
 *
